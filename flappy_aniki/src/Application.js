...
//        this.config.screenshotMode = true;
        ...
        this.config.storeIOS = "https://itunes.apple.com/us/app/fuguppifugu/id815166506?l=ja&ls=1&mt=8";
        this.config.storeAndroid = "https://play.google.com/store/apps/details?id=com.sonicmoov.mini.flappy_fugu";
        this.config.googleAnalyticsUAIOS = "UA-47071883-xx";
        this.config.googleAnalyticsUAAndroid = "UA-47071883-xx";
        ...
        this.config.herlockRankingId = "dev";
