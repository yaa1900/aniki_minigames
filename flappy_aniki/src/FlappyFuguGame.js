...
//            this._character = new Character( false, this.user.activeCharaName );
        ...
        _onInit: { value: function(){
            ...
            this._character.display.scaleX = this._character.display.scaleY = 2;
...
//            this._speed += 0.01/60;
    ...
    var Character = function ( stop, charaId ){
        ...
        this.assets.onload = function( assets ){
            self._walkSprite = new Bitmap( new BitmapData( assets.spriteSheet ) );
        ...
        this._hitArea.x = -30;
        this._hitArea.y = -22;
        this._hitArea.width = 57 * 0.7;
        this._hitArea.height = 44* 0.7;
    ...
    Character.prototype = Object.create( {}, {
        ...
        _init: { value: function(){
            ...
            this._container.addChild( this._walkSprite );
